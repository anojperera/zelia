...
#define Z_SHT_ATTRIB_SZ1 4
#define Z_SHT_ATTRIB_SZ2 8
...
/* Damper shafts */
#define Z_SHAFT_EXTRA 15.0			/* shaft extra */
#define Z_SHAFT_DIA 19.0			/* shaft diameter */

/* Bearing dimensions */
/* cutdown bearing dimensions */
#define Z_BEARING_CT_FLANGE_THICKNESS 2.0
